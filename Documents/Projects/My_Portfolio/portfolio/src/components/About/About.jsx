...
const About = () => {
  ...
  const skillDetails = {
    webdev: {
      ...
      items: [
        ...
        },
        {
          ...
          name: 'DevOps',
          skills: ['Git', 'Docker', 'CI/CD', 'AWS', 'Kubernetes (Basics)']
        }
      ]
    },
    uiux: {
    ...
    problem: {
      ...
      achievements: [        'Participated in 13+ coding contests',
          'Top 20% LeetCode Global Ranking'
      ]
    },
  };
  ...
  return (
    <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-gray-300 space-y-6">
                ...
                <p className="leading-relaxed">
                  With over 1 year of experience in web development, I
                  specialize in creating scalable and efficient web
                  applications. My journey in technology has been driven by a
                  passion for solving complex problems and creating impactful
                  digital solutions.
                </p>
                <p className="leading-relaxed">
                  I believe in writing clean, maintainable code and staying
                  up-to-date with the latest industry trends and best practices.
                  My goal is to deliver high-quality solutions that not only
                  meet technical requirements but also provide an exceptional
                  user experience.
                </p>
                <div className="grid grid-cols-2 gap-4 pt-4">
                  <div className="space-y-2">
                    <p>
                      <span className="text-red-500">Name:</span> Sabari
                    </p>
                    <p>
                      <span className="text-red-500">Experience:</span> 1+ Years
                    </p>
                  </div>
                  <div className="space-y-2">
                    <p>
                      <span className="text-red-500">Location:</span> Remote
                    </p>
                    <p>
                      <span className="text-red-500">Available:</span> Freelance
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="space-y-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {mainSkills.map((skill) => (
                ...
                >
                  <div
                    className={`absolute inset-0 bg-gradient-to-r ${skill.color} ${skill.hoverColor} rounded-xl opacity-50 transition-opacity duration-300`}
                  ></div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      ...
                      <div className="grid grid-cols-3 gap-4 mb-4">
                        <div className="text-center">
                          <div className="text-2xl font-bold text-red-500">
                            {skillDetails.problem.leetcode.stats.solved}
                          </div>
                        ...
                        <div className="text-center">
                          <div className="text-2xl font-bold text-red-500">
                            {skillDetails.problem.leetcode.stats.ranking}
                          </div>
                          <div className="text-sm text-gray-400">
                            Global Ranking
                          </div>
                        ...
                        <div className="text-center">
                          <div className="text-2xl font-bold text-red-500">
                            {skillDetails.problem.leetcode.stats.contest}
                          </div>
                          <div className="text-sm text-gray-400">
                            Contest Rating
                          </div>
                    ...
                    <div className="bg-gray-900/50 rounded-xl p-6">
                      ...
                      <ul className="list-disc pl-6 text-gray-400 space-y-2">
                        {skillDetails.problem.achievements.map(
                          (achievement, index) => (
      ...
      <section
        id="achievements"
        className="relative py-20 bg-gradient-to-b from-gray-900 via-black to-gray-900"
      >
        <div className="container mx-auto px-4 max-w-6xl">
          <h2 className="text-4xl font-bold text-center text-white mb-4">
            Achieve<span className="text-red-500">ments</span>
          </h2>
          <div className="w-24 h-1 bg-red-500 mx-auto mb-8"></div>

          <ul className="space-y-6 text-gray-300 text-lg list-disc list-inside">
            <li>Contributed to open-source projects</li>
            <li>Mentored junior developers</li>
            <li>Optimized critical system components</li>
            <li>
              Secured 4th Place and "Legend of Hack" award in 24hr Hackathon
            </li>
          </ul>
        </div>
      </section>
